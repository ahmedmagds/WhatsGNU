...
PARSER.add_argument("-q", "--fasta", type=str, help="a FASTA file of sequences for the genes of interest for heatmap or metadata barplot",)
...
PARSER.add_argument("-c", "--cutoff_volcano", type=int, help="a percentage of isolates a gene must be in [Default: 100]",)
